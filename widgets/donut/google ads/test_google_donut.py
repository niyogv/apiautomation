...
payload = read_from_file('/test//donut/google ads/payload.json')
payload['report']['create']['reportName'] = fake.name()
...
class Test_donut():
    ...
    def test_create_standard_metrics(self):
        ...
        payload_donut_chart = payload['donut'].copy()
        ...
        assert response_body['startDate'] == '2024-04-22T00:00:00.000+00:00'
        assert response_body['endDate'] == '2025-04-21T23:59:59.999+00:00'
    ...
    def test_update_custom_metric(self):
        ...
        Test_donut.widget_body['recordType'] = 'GOOGLE_ADS_KEYWORD'
        ...
        Test_donut.widget_body['donutChart']['metric']['key'] = 'automation_backend_google_ads_custom_metrics_C_1_C'
    ...
    def test_update_custom_dimension(self):
        ...
        Test_donut.widget_body['donutChart']['metric']['key'] = 'automation_backend_google_ads_custom_dimension_C_1_C'
        headers = {
            "Authorization": Test_donut.auth,
            "Content-Type": "application/json"
        }
    ...
    def test_update_funnel_stage(self):
        ...
        Test_donut.widget_body['startDate'] = '2022-03-17T00:00:00.000+00:00'
        Test_donut.widget_body['endDate'] = '2024-03-17T23:59:59.999+00:00'
        Test_donut.widget_body['donutChart']['metric']['key'] = 'automation_backend_google_ads_funnel_stage_C_1_C'
        headers = {
            "Authorization": Test_donut.auth,
            "Content-Type": "application/json"
        }
    ...
    def test_update_funnel_metric(self):
        ...
        Test_donut.widget_body['startDate'] = '2022-03-17T00:00:00.000+00:00'
        Test_donut.widget_body['endDate'] = '2024-03-17T23:59:59.999+00:00'
        Test_donut.widget_body['donutChart']['metric']['key'] = 'automation_backend_google_ads_funnel_metrics_C_1_C'
        headers = {
            "Authorization": Test_donut.auth,
            "Content-Type": "application/json"
        }
    ...
    def test_global_filter_add(self):
        url = property['chart']['create chart'] + '/' + Test_donut.widget_id + "/" + "widget-id"
        payload_line_chart = Test_donut.widget_body
        payload_line_chart['globalFiltersMap'] = payload['global filter']['globalFiltersMap']
        payload_line_chart['widgetFilters'] = payload['global filter']['widget filter']
    ...
    def test_delete_widget(self):
        url = property['chart'][
                  'delete chart'] + Test_donut.report_id + "/report-id" + "/" + Test_donut.widget_id + "/widget-id"
        headers = {
            "Authorization": Test_donut.auth,
            "Content-Type": "application/json"
        }
