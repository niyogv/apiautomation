...
payload=read_from_file('/test//line/ga4 line chart/payload.json')
payload['report']['create']['reportName']=fake.name()
...
class Test_line():
    ...
    def test_create_standard_metrics(self):
        ...
        assert response_body["lineChartWithOneDropdown"]["yAxis"][0]["key"] == "activeUsers"
        assert response_body['startDate']=='2025-02-16T00:00:00.000+00:00'
    ...
    def test_global_filter_add(self):
        ...
        payload_line_chart['widgetFilters'] = payload['report']['global filter']['widget filter']['widgetFilters']
        data = payload_line_chart
        headers = {
            "Authorization": Test_line.auth,
            "Content-Type": "application/json"
    ...
    def test_get_widgets(self):
        ...
        assert response_body['widgets'][0]['startDate']=='2025-02-16T00:00:00.000+00:00'
        assert response_body['widgets'][0]['endDate']=='2025-03-17T23:59:59.999+00:00'
        assert response_body['widgets'][0]['dateRangeType']=='LAST_THIRTY_DAYS'
    ...
    def test_update_custom_metric(self):
        ...
        Test_line.widget_body['recordType']='GA4_ACCOUNT'
        ...
        Test_line.widget_body['lineChartWithOneDropdown']['yAxis'][0]['key']='automation_backend_ga4_custom_metrics_C_1_C'
    ...
    def test_update_funnel_stage(self):
        ...
        Test_line.widget_body['endDate']='2024-03-17T23:59:59.999+00:00'
        Test_line.widget_body['lineChartWithOneDropdown']['xAxis'][0]['key']='date'
        Test_line.widget_body['lineChartWithOneDropdown']['yAxis'][0]['key']='automation_backend_funnel_stage_ga4_C_1_C'
    ...
    def test_update_funnel_metric(self):
        ...
        Test_line.widget_body['endDate']='2024-03-17T23:59:59.999+00:00'
        Test_line.widget_body['lineChartWithOneDropdown']['xAxis'][0]['key']='date'
        Test_line.widget_body['lineChartWithOneDropdown']['yAxis'][0]['key']='automation_backend_funnel_metrics_ga4_C_1_C'
        Test_line.widget_body['lineChartWithOneDropdown']['yAxis'][0]['customMetric']=False
        headers = {
            "Authorization": Test_line.auth,
            "Content-Type": "application/json"
    ...
    def test_widget_expansion(self):
        ...
        assert response_body[0]['GA4_Funnel_Stage_3_C_1_C']==351
        assert response_body[2]['date'] == '01-01-2024'
        assert response_body[2]['year'] == '2024'
        assert response_body[2]['GA4_Funnel_Stage_3_C_1_C'] == 10343
    ...
    def test_two_dropdown(self):
        ...
        y_axis.append({
            ...
            "dataType": "FLOAT",
            "defaultField": False,
            "displayName": "Scrolled Users",
            "funnelMetric": False,
            "funnelStage": False,
            "integrationType": "GOOGLE_ANALYTICS_FOUR",
            "key": "scrolledUsers",
            "objectType": "GA4_ACCOUNT",
            "objectTypeDisplayName": "Account",
            "prefix": "",
            "suffix": ""
        })
