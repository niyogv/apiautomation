...
payload=read_from_file('/test/line/google ads line chart/payload.json')
payload['report']['create']['reportName']=fake.name()
...
class Test_line():
    ...
    def test_create_standard_metrics(self):
        ...
        assert response_body['integrationType']=='GOOGLE_ADS'
        assert response_body["lineChartWithOneDropdown"]["xAxis"][0]["key"] == "date"
        assert response_body["lineChartWithOneDropdown"]["yAxis"][0]["key"] == "clicks"
        assert response_body['startDate']=='2024-03-18T00:00:00.000+00:00'
        assert response_body['endDate']=='2025-03-17T23:59:59.999+00:00'
        assert response_body['dateRangeType']=='DAY_LAST_THREE_SIXTY_FIVE_DAYS'
        assert response_body['aggregation']=='DAILY'
        assert response_body['recordType']=='GOOGLE_ADS_KEYWORD'
    ...
    def test_get_widgets(self):
        ...
        assert response_body['widgets'][0]['integrationType']=='GOOGLE_ADS'
        assert response_body['widgets'][0]['chartType']=='LINE_CHART_WITH_ONE_DROPDOWN'
        assert response_body['widgets'][0]['startDate']=='2024-03-18T00:00:00.000+00:00'
        ...
        assert response_body['widgets'][0]['aggregation']=='DAILY'
        assert response_body['widgets'][0]['recordType']=='GOOGLE_ADS_KEYWORD'
    ...
    def test_update_custom_metric(self):
        ...
        Test_line.widget_body['recordType']='GOOGLE_ADS_KEYWORD'
        ...
        Test_line.widget_body['lineChartWithOneDropdown']['xAxis'][0]['key']='date'
        Test_line.widget_body['lineChartWithOneDropdown']['yAxis'][0]['key']='automation_backend_google_ads_custom_metrics_C_1_C'
    ...
    def test_update_custom_dimension(self):
        ...
        Test_line.widget_body['endDate']='2024-03-17T23:59:59.999+00:00'
        Test_line.widget_body['lineChartWithOneDropdown']['xAxis'][0]['key']='date'
        Test_line.widget_body['lineChartWithOneDropdown']['yAxis'][0]['key']='automation_backend_google_ads_custom_dimension_C_1_C'
    ...
    def test_update_funnel_stage(self):
        ...
        Test_line.widget_body['chartHeight']=20
        Test_line.widget_body['excludeWeekends']=True
        Test_line.widget_body['aggregation']='QUARTERLY'
        Test_line.widget_body['recordType']='GOOGLE_ADS_KEYWORD'
        Test_line.widget_body['dateRangeType']='CUSTOM'
        Test_line.widget_body['startDate']='2022-03-17T00:00:00.000+00:00'
        Test_line.widget_body['endDate']='2024-03-17T23:59:59.999+00:00'
        Test_line.widget_body['lineChartWithOneDropdown']['xAxis'][0]['key']='date'
        Test_line.widget_body['lineChartWithOneDropdown']['yAxis'][0]['key']='automation_backend_google_ads_funnel_stage_C_1_C'
        Test_line.widget_body['lineChartWithOneDropdown']['yAxis'][0]['customMetric']=False
        headers = {
            "Authorization": Test_line.auth,
            "Content-Type": "application/json"
    ...
    def test_update_funnel_metric(self):
        ...
        Test_line.widget_body['endDate']='2024-03-17T23:59:59.999+00:00'
        Test_line.widget_body['lineChartWithOneDropdown']['xAxis'][0]['key']='date'
        Test_line.widget_body['lineChartWithOneDropdown']['yAxis'][0]['key']='automation_backend_google_ads_funnel_metrics_C_1_C'
        Test_line.widget_body['lineChartWithOneDropdown']['yAxis'][0]['customMetric']=False
        headers = {
            "Authorization": Test_line.auth,
            "Content-Type": "application/json"
    ...
    def test_two_dropdown(self):
        ...
        y_axis.append({
            ...
            "key": "impressions",
            "objectType": "GOOGLE_ADS_KEYWORD",
            "objectTypeDisplayName": "Keyword",
            "prefix": "",
            "suffix": ""
        })
